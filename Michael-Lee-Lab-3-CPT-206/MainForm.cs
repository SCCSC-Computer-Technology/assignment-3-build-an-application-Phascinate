...
namespace Michael_Lee_Lab_3_CPT_206
{
    public partial class MainForm : Form
    {
        ...
        // Note: You will notice a missing Class Library.
        // Unfortunately, I ran into SO many issues with the class
        // library that I think I would need to just restart the whole
        // project to get it to work correctly. So many version issues,
        // database import issues, etc.
            ...
            try
            {
                ...
                if (stateToDelete != null)
                {
                    ...
                    if (confirm == DialogResult.Yes)
                    {
                        ...
                        appDbContext.States.Remove(stateToDelete);
